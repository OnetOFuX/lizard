...
- `infra/compose.yml`: levanta config, eureka y gateway en la red `lizard-prod-net`.
...
- `JwtService` emite tokens firmados con secreto compartido y `issuer: lizardstore-auth`.
